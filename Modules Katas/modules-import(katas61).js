...
import {equal, deepEqual, notEqual, equal as myEqual} from 'assert';
import {default as myAssert} from 'assert';
// or you can use, [import myAssert from 'assert'] instead and it will do the same as using the word default
